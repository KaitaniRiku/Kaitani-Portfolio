...
/**
 * Nom de la class: IndexController()
 *
...
namespace App\Controllers\Simple_controllers\Site;

class IndexController extends \Core\System\ControllersProviderSystem
{
    /**
